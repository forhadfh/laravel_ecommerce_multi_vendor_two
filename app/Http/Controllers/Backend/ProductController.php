...
class ProductController extends Controller
{
    ...
    public function EditProduct($id){
        ...
        return view('backend.product.product_edit',compact('brands','categories','subcategories','activeVendor','products','multiImgs'));
    }//End Method
    ...
    public function ProductDetails($id){
        ...
        $subcategories = SubCategory::latest()->get();
        $products = Product::findOrFail($id);
        return view('backend.product.product_details',compact('brands','categories','subcategories','activeVendor','products','multiImgs'));
    }//End ProductDetails
