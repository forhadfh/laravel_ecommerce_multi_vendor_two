...
class IndexController extends Controller
{
    ...
    public function Index(){
        ...
        // $special_offer = Product::where('special_offer',1)->where('discount_price','!=',NULL)->orderBy('id', 'DESC')->limit(4)->get();


        // $new = Product::where('status',1)->orderBy('id','DESC')->limit(4)->get();

        // $special_deals = Product::where('special_deals',1)->where('discount_price','!=',NULL)->orderBy('id', 'DESC')->limit(4)->get();
        ...
        return view('frontend.index',compact('skip_category_0','skip_product_0','skip_category_2',
        'skip_product_2','skip_category_1','skip_product_1','hot_deals','special_offer','new','special_deals'));
    }
    ...
    $vendors = User::where('status', 'active')->where('role','vendor')
    ->orderBy('id','ASC')->get();
        return view('frontend.vendor.vendor_all',compact('vendors'));
    }


    // category & SubCatWiseProduct sulg--------------------------------------------------------
    ...
    public function ProductViewAjax($id){
        $product = Product::with('subcategory','category','brand',)->findOrFail($id);
