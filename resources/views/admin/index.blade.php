...
@php
    ...
    $costomer = App\Models\User::where('status','active')->where('role','user')->get();
@endphp
    ...
    <div class="row row-cols-1 row-cols-md-2 row-cols-xl-4">
            ...
            <div class="card radius-10 bg-gradient-deepblue">
             <div class="card-body">
                ...
                <div class="d-flex align-items-center text-white">
                    ...
                    <p class="mb-0 ms-auto">+{{ $today }}<span><i class='bx bx-up-arrow-alt'></i></span></p>
                </div>
            </div>
          </div>
        </div>
        <div class="col">
            ...
            <div class="card-body">
                ...
                <div class="d-flex align-items-center text-white">
                    ...
                    <p class="mb-0 ms-auto">+{{ $month }}<span><i class='bx bx-up-arrow-alt'></i></span></p>
                </div>
            </div>
          </div>
        </div>
        <div class="col">
            ...
            <div class="card-body">
                ...
                <div class="d-flex align-items-center text-white">
                    <p class="mb-0">Yearle Sale</p>
                    <p class="mb-0 ms-auto">+{{ $year }}<span><i class='bx bx-up-arrow-alt'></i></span></p>
                </div>
            </div>
        </div>
        </div>
            ...
            <div class="card radius-10 bg-gradient-ibiza">
             <div class="card-body">
                ...
                <div class="d-flex align-items-center text-white">
                    ...
                    <p class="mb-0 ms-auto">+{{ count($pending) }}<span><i class='bx bx-up-arrow-alt'></i></span></p>
                </div>
            </div>
         </div>
        </div>
            ...
            <div class="card radius-10 bg-gradient-ibiza">
             <div class="card-body">
                ...
                <div class="d-flex align-items-center text-white">
                    ...
                    <p class="mb-0 ms-auto">+{{ count($vendor) }}<span><i class='bx bx-up-arrow-alt'></i></span></p>
                </div>
            </div>
         </div>
        </div>
        ...
        <div class="col">
            <div class="card radius-10 bg-gradient-ibiza">
             <div class="card-body">
                <div class="d-flex align-items-center">
                    <h5 class="mb-0 text-white">{{ count($costomer) }}</h5>
                    <div class="ms-auto">
                        <i class='bx bx-envelope fs-3 text-white'></i>
                    </div>
                </div>
                ...
                <div class="d-flex align-items-center text-white">
                    ...
                    <p class="mb-0 ms-auto">+{{ count($costomer) }}<span><i class='bx bx-up-arrow-alt'></i></span></p>
                </div>
            </div>
         </div>
        </div>
