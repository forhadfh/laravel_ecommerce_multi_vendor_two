		...
		<form id="myForm" method="post" action="{{ route('update.blog.post') }}" enctype="multipart/form-data" >
		 ...
		 <div class="row mb-3">
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-9 text-secondary">
                    <textarea name="post_short_description" class="form-control" id="inputProductDescription" required rows="3">
            ...
            <div class="row mb-3 form-group">
                ...
                <div class="form-group col-sm-9 text-secondary" {{ __('post_long_description') }}>
                    <textarea class="form-control mytextarea"  name="post_long_description" required>
                        {!! $blogpost->post_short_description !!}
                    </textarea>
