                    ...
                    <div class="header-action-right">
                        <div class="header-action-2">
                            ...
                            <div class="header-action-icon-2">
                                ...
                                <span class="lable ml-0" style="margin-left: 2px; margin-right: 2px;"> | </span>
                        ...
                        <nav>
                            <ul>
                                ...
                                <li>
                                    ...
                                    @php
                                    $subcategories =
                                    App\Models\SubCategory::where('category_id',$category->id)->orderBy('subcategory_name','DESC')->get();
                                    @endphp
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li><a
                                                href="{{ url('product/subcategory/'.$subcategory->id.'/'.$subcategory->subcategory_slug) }}">{{$subcategory->subcategory_name
                                                }}</a></li>
                                        @endforeach
        ...
        <div class="mobile-header-content-area">
            ...
            <div class="mobile-header-info-wrap">
                ...
                <div class="single-mobile-header-info">
                    <a href="{{ route('user.logout') }}"><i class="fi-rs-marker"></i>Sign out </a>
                </div>

                @else
                <div class="single-mobile-header-info">
                    <a href="{{ route('register') }}"><i class="fi-rs-marker"></i>Sign Up </a>
                </div>
                <div class="single-mobile-header-info">
