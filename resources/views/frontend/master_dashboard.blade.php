...
// Qucik view start product modal--------------------------------------------------------------
    ...
    function addToCart(){
        ...
        $.ajax({
           ...
           success:function(data){
            ...
            // END start message display
           }
        })
       }
       /// End Add To Cart Prodcut

       /// Start Details page add to cart Prodcut
    function addToCartDetails(){
       ...
       // End Details page add to cart Prodcut
    </script>

    {{-- product add nini cart --}}
                ...
                $.each(response.carts, function(key, value){
                    miniCart += `   <ul>
                                        <li>
                                            ...
                                            <div class="shopping-cart-delete" style="margin: -60px 1px 0px;">
    ...
    function miniCartRemove(rowId){
        $.ajax({
            type: 'Get',
            url: '/minicart/product/romove/'+rowId,
            dataType: 'json',
            success:function(data){
                miniCart();
                //start message display
                                ...
                                <td class="text-center detail-info" data-title="Stock">
                                    <div class="detail-extralink mr-15">
                                        ...
                                        <input type="text" name="quantity" class="qty-val" value="${value.qty}" min="1">
                                            ...
                                            <a type="submit" class="qty-up" id="${value.rowId}" onclick="cartIncrenemt(this.id)">
