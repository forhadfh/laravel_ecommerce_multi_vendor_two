                    ...
                    <div class="tab-pane fade active show" id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="mb-0">Return Orders Page</h3>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ url('user/invoice_download/'.$order->id) }}" class="btn-sm btn-primary"><i class="fa fa-download"></i> Invoice</a>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
