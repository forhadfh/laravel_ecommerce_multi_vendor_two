            ...
            <div class="mb-3">
			  ...
			  <div class="form-group mb-3">
			   ...
			   <div class="mb-3 form-group">
				<label for="inputProductDescription"  {{ __('Long Description') }} class="form-label">Long Description</label>
				<textarea class="form-control mytextarea"  name="long_descp" required ></textarea>
                @error('long_descp')<span class="text-danger">{{ $message }}</span>@enderror
			  </div>

              <div class="mb-3 form-group ">
				<label for="inputProductDescription" {{ __('Product Info') }}  class="form-label">Product Info</label>
				<textarea class="form-control mytextarea"  name="product_info" required ></textarea>
