          ...
          <hr/>
           ...
           <div class="form-body mt-4">
            ...
            <div class="form-group mb-3">
                ...
                <textarea class="form-control"  name="long_descp"rows="3"  >{!! $products->long_descp !!}</textarea>
            </div>

            <div class="form-group mb-3">
                <label for="longdescription"  class="form-label">Long Description</label>
                <textarea class="form-control"   id="mytextarea" name="product_info"rows="3"  >{{ $products->product_info }}</textarea>
            </div>
