                ...
                <div class="col-lg-8">
                    <div class="border border-3 p-4 rounded">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control mytextarea"  name="long_descp"rows="3"  >{!! $products->long_descp !!}</textarea>
                        ...
                        <div class="form-group mb-3  ">
                            ...
                            <textarea class="form-control mytextarea" name="product_info" rows="3" required >{!! $products->product_info !!}</textarea>
...
<div class="page-content">
        ...
        <div class="ms-auto">
            <div class="btn-group">
                <a href="{{ route('vendor.all.product') }}">
                <button type="button" class="btn btn-info">BACK PAGE</button>
                </a>
            </div>
        </div>
        <hr>
            ...
            $.each(data, function(index, file){ //loop though each file
                if(/(\.|\/)(gif|jpe?g|png|webp)$/i.test(file.type)){ //check supported file type
                    ...
                    .height(80); //create image element
                        $('#preview_imgs').append(img); //append image to output element
                    };
                    })(file);
