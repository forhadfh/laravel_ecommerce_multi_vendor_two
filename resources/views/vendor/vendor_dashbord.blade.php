...
<head>
	...
	<script src="{{ asset('adminbackendassets/js/pace.min.js') }}"></script>
	<!-- Bootstrap CSS -->
...
<body>
	...
	<script src="{{ asset('adminbackend/assets/plugins/simplebar/js/simplebar.min.j') }}s"></script>
	...
	<script src="{{ asset('adminbackend/assets/plugins/jquery-knob/excanvas.j') }}s"></script>
